...
const Sprite = (() => {
  ...
  const META = {
    ...
    // 모자 착용 서기 시트 (주인공×모자, 4프레임) — Sprite.hat 이 있으면 idle/wave/dance/jump 가 이 시트로 해석된다
    bunny_idle_hat_beanie: { frames: 4, w: 190, h: 256, charRatio: 0.922 },
    bunny_idle_hat_crown: { frames: 4, w: 205, h: 256, charRatio: 0.898 },
    bunny_idle_hat_explorer: { frames: 4, w: 215, h: 256, charRatio: 0.93 },
    bunny_idle_hat_party: { frames: 4, w: 196, h: 256, charRatio: 0.922 },
    bunny_idle_hat_star: { frames: 4, w: 220, h: 256, charRatio: 0.93 },
    bunny_idle_hat_wizard: { frames: 4, w: 197, h: 256, charRatio: 0.922 },
    dino_idle_hat_beanie: { frames: 4, w: 149, h: 256, charRatio: 0.945 },
    dino_idle_hat_crown: { frames: 4, w: 151, h: 256, charRatio: 0.926 },
    dino_idle_hat_explorer: { frames: 4, w: 167, h: 256, charRatio: 0.945 },
    dino_idle_hat_party: { frames: 4, w: 142, h: 256, charRatio: 0.934 },
    dino_idle_hat_star: { frames: 4, w: 156, h: 256, charRatio: 0.934 },
    dino_idle_hat_wizard: { frames: 4, w: 162, h: 256, charRatio: 0.934 },
    owl_idle_hat_beanie: { frames: 4, w: 181, h: 256, charRatio: 0.922 },
    owl_idle_hat_crown: { frames: 4, w: 197, h: 256, charRatio: 0.914 },
    owl_idle_hat_explorer: { frames: 4, w: 227, h: 256, charRatio: 0.949 },
    owl_idle_hat_party: { frames: 4, w: 180, h: 256, charRatio: 0.922 },
    owl_idle_hat_star: { frames: 4, w: 209, h: 256, charRatio: 0.898 },
    owl_idle_hat_wizard: { frames: 4, w: 198, h: 256, charRatio: 0.938 },
    pig_idle_hat_beanie: { frames: 4, w: 174, h: 256, charRatio: 0.938 },
    pig_idle_hat_crown: { frames: 4, w: 187, h: 256, charRatio: 0.934 },
    pig_idle_hat_explorer: { frames: 4, w: 188, h: 256, charRatio: 0.934 },
    pig_idle_hat_party: { frames: 4, w: 171, h: 256, charRatio: 0.941 },
    pig_idle_hat_star: { frames: 4, w: 184, h: 256, charRatio: 0.91 },
    pig_idle_hat_wizard: { frames: 4, w: 180, h: 256, charRatio: 0.934 },
    poko_idle_hat_beanie: { frames: 4, w: 150, h: 256, charRatio: 0.93 },
    poko_idle_hat_crown: { frames: 4, w: 161, h: 256, charRatio: 0.922 },
    poko_idle_hat_explorer: { frames: 4, w: 174, h: 256, charRatio: 0.926 },
    poko_idle_hat_party: { frames: 4, w: 147, h: 256, charRatio: 0.938 },
    poko_idle_hat_star: { frames: 4, w: 162, h: 256, charRatio: 0.914 },
    poko_idle_hat_wizard: { frames: 4, w: 165, h: 256, charRatio: 0.945 },
    sheep_idle_hat_beanie: { frames: 4, w: 172, h: 256, charRatio: 0.941 },
    sheep_idle_hat_crown: { frames: 4, w: 180, h: 256, charRatio: 0.957 },
    sheep_idle_hat_explorer: { frames: 4, w: 182, h: 256, charRatio: 0.941 },
    sheep_idle_hat_party: { frames: 4, w: 173, h: 256, charRatio: 0.945 },
    sheep_idle_hat_star: { frames: 4, w: 196, h: 256, charRatio: 0.953 },
    sheep_idle_hat_wizard: { frames: 4, w: 172, h: 256, charRatio: 0.945 },
    squirrel_idle_hat_beanie: { frames: 4, w: 187, h: 256, charRatio: 0.906 },
    squirrel_idle_hat_crown: { frames: 4, w: 188, h: 256, charRatio: 0.918 },
    squirrel_idle_hat_explorer: { frames: 4, w: 202, h: 256, charRatio: 0.898 },
    squirrel_idle_hat_party: { frames: 4, w: 190, h: 256, charRatio: 0.91 },
    squirrel_idle_hat_star: { frames: 4, w: 208, h: 256, charRatio: 0.887 },
    squirrel_idle_hat_wizard: { frames: 4, w: 191, h: 256, charRatio: 0.957 },
    tiger_idle_hat_beanie: { frames: 4, w: 165, h: 256, charRatio: 0.93 },
    tiger_idle_hat_crown: { frames: 4, w: 168, h: 256, charRatio: 0.91 },
    tiger_idle_hat_explorer: { frames: 4, w: 176, h: 256, charRatio: 0.918 },
    tiger_idle_hat_party: { frames: 4, w: 161, h: 256, charRatio: 0.922 },
    tiger_idle_hat_star: { frames: 4, w: 174, h: 256, charRatio: 0.922 },
    tiger_idle_hat_wizard: { frames: 4, w: 165, h: 256, charRatio: 0.934 },
  ...
  let paused = false;
  let hero = "poko", hat = null;
  // 선택한 주인공에 맞춰 시트 이름을 바꾼다. 없는 동작은 비슷한 시트로 대체(손흔들기→서기, 춤→점프 반복)
  // 모자를 쓰면(Sprite.hat) 주인공×모자 착용 서기 시트({hero}_idle_hat_{hat})를 쓴다 — 캐릭터는 계속 움직이고 모자는 그려져 있다.
  //   착용 시트는 서기 동작뿐이라, 모자를 쓴 상태의 점프·손흔들기·춤은 착용 서기 시트로 대체(점프는 arc로 폴짝).
  const FALLBACK = { wave: "idle", dance: "jump" };
  function resolve(name) {
    if (!name.startsWith("poko_")) return name;
    const suffix = name.slice(5);
    if (hat) { const worn = `${hero}_idle_hat_${hat}`; if (META[worn] && ["idle", "wave", "dance", "jump"].includes(suffix)) return worn; }
    if (hero === "poko") return name;
  ...
  return {
    ...
    get hat() { return hat; }, set hat(v) { hat = v || null; },
  };
})();
